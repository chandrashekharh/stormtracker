...
(function() {
  ...
  StormTracker = (function(_super) {
    ...
    function StormTracker() {
      var AgentsManager, AgentsRegistry, CertificateFactory, CertificateRegistry, auth, fs;
      ...
      this.log("StormTracker constructor called, creating config datadir: " + global.config.datadir);
      fs = require('fs');
      fs.mkdir("" + global.config.datadir, function(result) {});
