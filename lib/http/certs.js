...
(function() {
  ...
  CertificateFactory = (function() {
    ...
    function CertificateFactory(db) {
      this.db = db;
      this.CM = new CertificateManager(global.config.folders.config, global.config.folders.tmp, this.db);
    }

    CertificateFactory.prototype.init = function() {
      var _this = this;
      return this.db.on("ready", function() {
  ...
  CertificateManager = (function() {
    ...
    CertificateManager.prototype.create = function(cert, callback) {
      ...
      if (cert.selfSigned) {
        ...
        return certainly.genCA(cert, function(err, cert) {
          if (err != null) {
            return callback(err);
          }
          try {
        ...
        return certainly.genKey(cert, function(err, ocert) {
          if (err != null) {
            return callback(err);
          }
  ...
  this.include = function() {
    ...
    this.post({
      "/cert": function() {
        ...
        return CM.create(this.body, function(err, cert) {
          if (err != null) {
